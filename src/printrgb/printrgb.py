                ...
                if angle_mode == 'inner':
                    ...
                    for i in text:
                        ...
                        if i == '':
                            ...
                            if 64 <= ord(i) <= 126:
                                j += i
                                printrgb(j,foreground_color=get_color(self.angle + x * 5 + y * 7),end = '',file = file)
                                j = ''
                                k = 0
                            else :
                                j += i
                    ...
                    for i in text:
                        ...
                        if i == '':
                            ...
                            if 64 <= ord(i) <= 126:
                                j += i
                                printrgb(j,foreground_color=get_color(x * 5 + y * 7),end = '',file = file)
                                j = ''
                                k = 0
                            else :
                                j += i
                    ...
                    for i in text:
                        ...
                        if i == '':
                            ...
                            if 64 <= ord(i) <= 126:
                                j += i
                                printrgb(j,foreground_color=get_color(angle + x * 5 + y * 7),end = '',file = file)
                                j = ''
                                k = 0
                            else :
                                j += i
